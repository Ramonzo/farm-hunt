...
public class ArrowDown extends JComponent {
    ...
    public ArrowDown() {
        buttonSprite = new ButtonSprite(Constants.GUI_PATH + "/arrow_down_small_base.png",
                Constants.GUI_PATH + "/arrow_down_small_hover.png", Constants.GUI_PATH + "/arrow_down_small_click.png");
