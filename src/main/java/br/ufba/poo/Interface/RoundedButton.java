...
public class RoundedButton extends JComponent {
    ...
    public RoundedButton() {
        buttonSprite = new ButtonSprite(Constants.GUI_PATH + "/button_rounded_small_base.png",
                Constants.GUI_PATH + "/button_rounded_small_hover.png",
                Constants.GUI_PATH + "/button_rounded_small_click.png");
